...
#embedding dimension
parser.add_argument("--dimension",default=300,type=int,help="embedding dimension")
...
if mode == 'Train':
    ...
    dataset_train = Dataset(Train_data_path,word2vec,dimension,mode='Train')
    ...
    dataset_eval = Dataset(Eval_data_path,word2vec,dimension,mode='Eval')
...
#Predict Mode
    ...
    dataset_test = Dataset(Test_data_path,word2vec,dimension,mode='Test')
